...
namespace Utils.Classes
{
	public class DataCryptography 
	{
		...
		#region Singlton
		private static DataCryptography m_singlton = null;
		public static DataCryptography Singleton
		{
			get
			{
				if (m_singlton == null) 
					m_singlton = new DataCryptography();
				return m_singlton;
			}
		}
		#endregion 

        #region Constructor setting for oxbridge
            //passPhrase = "oxbridge"; // can be any string			 
            //saltValue = "really"; // can be any string 			
        ...
        #region Constructor setting for someother
        //passPhrase = "Irf@nAfz@l"; // can be any string			 
        //saltValue = "a12131415161718191"; // can be any string 			
        //hashAlgorithm = "SHA1"; // can be "MD5" 			
        //passwordIterations = 2; // can be any number 			
        //initVector = "@1B2c3DeckERg7H8"; // must be 16 bytes 			
        //keySize = 256; // can be 192 or 128
        #endregion
