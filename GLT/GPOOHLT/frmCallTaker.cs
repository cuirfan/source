...
//using CMS.Despatcher;
//using CMS.Despatcher;


namespace GPOOHLT
{
    public partial class frmCallTaker : Form
    {
        List<PersonalDetails> m_objList = new List<PersonalDetails>();
        UserControlBrowse objUsrcntrl = new UserControlBrowse();
        public frmCallTaker()
        {
            InitializeComponent();
        ...
        private void ReadAndSetData(DataTable objDT)
        {
            ...
            {
                m_objList.Add(new PersonalDetails()
                {
                    ...
                    //FileVersion = Convert.ToString(row["FileVersion"]),
                });
            }
        }
        ...
        private void CheckMultipleInvokes(Button objbtn,bool value)
        {
        ...
        private void bgw_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            CheckMultipleInvokes(btnClearData, false);
            CheckMultipleInvokes(btnSaveData, false);
            CheckMultipleInvokes(btnLoadPatient, false);
            CheckMultipleInvokes(btnClose, false);
            string result = SavePatientData();
        }

        private void bgw_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            CheckMultipleInvokes(btnClearData, true);
            CheckMultipleInvokes(btnSaveData, true);
            CheckMultipleInvokes(btnClose, true);
            CheckMultipleInvokes(btnLoadPatient, true);
            prgrsbar.Visible = false;            
        }

        private void frmCallTaker_FormClosing(object sender, FormClosingEventArgs e)
        {
